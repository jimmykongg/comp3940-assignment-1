...
<head>
    ...
    %>
    <script>
        let delayBeforeShowingAnswer = 5000; // 5 seconds before showing the correct answer
        let delayBeforeNextQuestion = 3000; // 3 seconds after showing the correct answer
